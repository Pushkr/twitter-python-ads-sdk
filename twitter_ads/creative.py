...
class PromotedAccount(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/promoted_accounts'
    RESOURCE = '/2/accounts/{account_id}/promoted_accounts/{id}'
...
class PromotedTweet(Resource, Persistence, Analytics):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/promoted_tweets'
    RESOURCE = '/2/accounts/{account_id}/promoted_tweets/{id}'
...
class Video(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/videos'
    RESOURCE = '/2/accounts/{account_id}/videos/{id}'
...
resource_property(Video, 'video_media_id', transform=TRANSFORM.INT)
...
class AccountMedia(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/account_media'
    RESOURCE = '/2/accounts/{account_id}/account_media/{id}'
...
class MediaCreative(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/media_creatives'
    RESOURCE = '/2/accounts/{account_id}/media_creatives/{id}'
...
class WebsiteCard(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/cards/website'
    RESOURCE = '/2/accounts/{account_id}/cards/website/{id}'
...
class LeadGenCard(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/cards/lead_gen'
    RESOURCE = '/2/accounts/{account_id}/cards/lead_gen/{id}'
...
class AppDownloadCard(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/cards/app_download'
    RESOURCE = '/2/accounts/{account_id}/cards/app_download/{id}'
...
class ImageAppDownloadCard(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/cards/image_app_download'
    RESOURCE = '/2/accounts/{account_id}/cards/image_app_download/{id}'
...
class VideoAppDownloadCard(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/cards/video_app_download'
    RESOURCE = '/2/accounts/{account_id}/cards/video_app_download/{id}'
...
class ImageConversationCard(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/cards/image_conversation'
    RESOURCE = '/2/accounts/{account_id}/cards/image_conversation/{id}'
...
class VideoConversationCard(Resource, Persistence):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/cards/video_conversation'
    RESOURCE = '/2/accounts/{account_id}/cards/video_conversation/{id}'
