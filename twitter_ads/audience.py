...
class TailoredAudience(Resource):
    ...
    RESOURCE_COLLECTION = '/2/accounts/{account_id}/tailored_audiences'
    RESOURCE = '/2/accounts/{account_id}/tailored_audiences/{id}'
    RESOURCE_UPDATE = '/2/accounts/{account_id}/tailored_audience_changes'
    RESOURCE_PERMISSIONS = '/2/accounts/{account_id}/tailored_audiences/{id}/permissions'
    OPT_OUT = '/2/accounts/{account_id}/tailored_audiences/global_opt_out'
...
class TailoredAudiencePermission(Resource):
    ...
    RESOURCE = '/2/accounts/{account_id}/tailored_audiences/{tailored_audience_id}/permissions/{id}'
